<template>
    ...
    <div class="Admin-Content">
        <Arrange_film v-if="name === '1' "></Arrange_film>
        <Movie_library v-else-if="name === '2'"></Movie_library>
        <Ticket v-else-if="name==='3'"></Ticket>
        <Seat v-else-if="name === '4'"></Seat>
    </div>
</template>
<script>
...
export default {
    components: {Ticket, Seat, Movie_library, Upload, Arrange_film, Menu, Icon, MenuItem, MenuGroup, Radio, RadioGroup},
    setup(){
        let name = ref("1")
